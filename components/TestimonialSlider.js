...
const testimonialData = [
  {
    image: `${process.env.NEXT_PUBLIC_BASE_PATH}/t-avt-1.png`,
    name: 'Anne Smith',
    position: 'Customer',
    message:
  ...
  {
    image: `${process.env.NEXT_PUBLIC_BASE_PATH}/t-avt-2.png`,
    name: 'Jane Doe',
    position: 'Customer',
    message:
      'Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum expedita odit beatae, cupiditate saepe quam officia aut placeat quas neque!',
  ...
  {
    image: `${process.env.NEXT_PUBLIC_BASE_PATH}/t-avt-3.png`,
    name: 'Jhon Doe',
    position: 'Customer',
    message:
      'Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum expedita odit beatae, cupiditate saepe quam officia aut placeat quas neque!',
          ...
          return (
            ...
            >
              ...
              >
                ...
                <div
                  className='w-full max-w-[300px] flex flex-col xl:justify-center relative mx-auto xl:mx-0'
                >
                  <div
